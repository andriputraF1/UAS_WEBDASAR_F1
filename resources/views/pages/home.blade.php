                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-7 pt-5">
                                    <h1 class="display-4 text-white mb-3 animated slideInDown">Let's Change The World With
                                        Humanity</h1>
                                    <p class="fs-5 text-white-50 mb-5 animated slideInDown">Mari Bantu Palestina!
                                        Kami mengajak Anda untuk memberikan dukungan bagi saudara-saudara kita di Palestina. 
                                        Setiap donasi, sekecil apapun, akan sangat berarti untuk mereka yang membutuhkan. 
                                        Bersama, kita bisa memberikan harapan dan kebaikan.</p>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-7 pt-5">
                                    <h1 class="display-4 text-white mb-3 animated slideInDown">Let's Save More Lifes With
                                        Our Helping Hand</h1>
                                    <p class="fs-5 text-white-50 mb-5 animated slideInDown">Kami mengajak Anda
                                         untuk berpartisipasi dalam program donasi
                                          untuk kaum dhuafa dan anak yatim
                                           yang diselenggarakan oleh UMSU. Setiap kontribusi, sekecil apapun, akan memberikan kebahagiaan dan harapan baru 
                                           bagi mereka yang membutuhkan. Bersama kita bisa membuat perbedaan</p>
                                    <a class="btn btn-primary py-2 px-3 animated slideInDown" href="">
                                        Learn More
                                        <div class="d-inline-flex btn-sm-square bg-white text-primary rounded-circle ms-2">
                                            <i class="fa fa-arrow-right"></i>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <div class="bg-light border-bottom border-5 border-primary rounded p-4 mb-4">
                            <p class="text-dark mb-2">KAMI BERKOMITMEN AGAR MENYALURKAN BANTUAN SECARA NYATA</p>
                            <span class="text-primary">Pukreng, Founder</span>
                        </div>
                        <p class="mb-5">YAYASAN INI MASIH TERBILANG BARU, TETAPI KAMI INGIN MENCIPTAKAN TRANSPARANSI DALAM BANTUAN SOSIAL</p>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">"Bantu anak-anak kita mencapai potensi terbaik mereka melalui pendidikan yang memadai. Bersama kita bisa! #DukungPendidikan #AnakCemerlang"</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">"Kesehatan Anda adalah prioritas kami. Dapatkan perawatan medis terbaik dengan layanan terpercaya. #PerawatanMedis #KesehatanTerjamin"</p>
                        <a class="btn btn-outline-primary px-3" href="">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">"Air minum bersih adalah hak setiap orang. Mari kita berkontribusi untuk menyediakan air yang murni bagi semua. #AirBersihUntukSemua #HidupSehat"</p>
                        <a class="btn btn-outline-primary px-3" href="">
                            Learn More
                            <div class="d-inline-flex btn-sm-square bg-primary text-white rounded-circle ms-2">
                                <i class="fa fa-arrow-right"></i>
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p class="text-white-50 mb-0">"Terima kasih atas hasil yang telah dicapai bersama Anda. Kerja keras dan dedikasi Anda telah memberikan dampak yang signifikan, dan kami sangat menghargai usaha Anda. Bersama-sama, kita telah mencapai hal-hal besar dan berharap untuk lebih banyak kesuksesan di masa depan."</p>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        ...
                        <div class="team-text bg-light text-center p-4">
                            <h5>Rika Yuli Anita</h5>
                            <p class="text-primary">Communications Manager</p>
                            <div class="team-social text-center">
                                <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-instagram"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        ...
                        <div class="team-text bg-light text-center p-4">
                            <h5>Ananda RM</h5>
                            <p class="text-primary">Data Analyst</p>
                            <div class="team-social text-center">
                                <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-instagram"></i></a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-5">"Dipercaya oleh Ribuan Orang dan Organisasi Nirlaba"</h1>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center">
                    ...
                    <div class="testimonial-text rounded text-center p-4">
                        <p>berbagi itu indah, dengan memanusiakan manusia dengan sebaik-baiknya melalui bantuan kemanusiaan
                        </p>
                        <h5 class="mb-1">Mbak Rey</h5>
                        <span class="fst-italic">Iphone Saler</span>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="assets/img/testimonial-2.jpg"
                        style="width: 100px; height: 100px;">
                    <div class="testimonial-text rounded text-center p-4">
                        <p>semoga sumbangan yang diberikan dapat membawa manfaat bagi 
                            saudara-saudara kita yang sedang mengalami musibah #alleyesonRAFAH
                        </p>
                        <h5 class="mb-1">Bang Ryan</h5>
                        <span class="fst-italic">usaha percetakan</span>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="assets/img/testimonial-3.jpg"
                        style="width: 100px; height: 100px;">
                    <div class="testimonial-text rounded text-center p-4">
                        <p>sumbangan yang kita berikan ke sesama akan bermanfaat untuk kemanusiaan, STOP! depo untuk judi online 
                        </p>
                        <h5 class="mb-1">Ryan Gunawan</h5>
                        <span class="fst-italic">Mas Gojek</span>
                    </div>
                </div>
            </div>
        </div>
